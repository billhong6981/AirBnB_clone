...
We used the module `cmd` in order to create our shell. And for practical reasons, our code should not be executed when imported
...
```
p.s. pressing `ENTER` with an empty line shouldn’t execute anything.
